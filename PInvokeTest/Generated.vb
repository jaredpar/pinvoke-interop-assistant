...
Public Class PInvokePointer
    ...
    Private m_ptr As System.IntPtr
    ...
    Public Sub New(ByVal size As Integer)
        MyBase.New
        m_ptr = System.Runtime.InteropServices.Marshal.AllocCoTaskMem(size)
        m_size = size
    End Sub
    ...
    Public Overridable Sub Free()
        System.Runtime.InteropServices.Marshal.FreeCoTaskMem(m_ptr)
        m_ptr = System.IntPtr.Zero
        m_size = 0
    End Sub
    
    Public Overridable Function ToByteArray() As Byte()
        Dim arr((m_size) - 1) As Byte
        System.Runtime.InteropServices.Marshal.Copy(m_ptr, arr, 0, m_size)
        Return arr
    End Function
