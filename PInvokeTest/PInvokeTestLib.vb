...
Namespace PInvokeTestLib
    ...
    <System.Runtime.InteropServices.StructLayoutAttribute(System.Runtime.InteropServices.LayoutKind.Sequential)> _
    Public Structure stringInStruct
    ...
    <System.Runtime.InteropServices.StructLayoutAttribute(System.Runtime.InteropServices.LayoutKind.Sequential)> _
    Public Structure structWithDiffStringTypes
    ...
    Public Structure tagDEC
        ...
        Public Union1 As Anonymous_3f4bb2d9_b5e3_482f_a1cd_89cd5b104462

        '''ULONG->unsigned int
        Public Hi32 As UInteger

        '''Anonymous_a0b7eb55_1311_474a_8d40_19409efee489
        Public Union2 As Anonymous_a0b7eb55_1311_474a_8d40_19409efee489
    End Structure
    ...
    Public Structure tagCY
        ...
        Public Struct1 As Anonymous_7b8f9219_bb63_4657_9da5_d001a008954a
    ...
    <System.Runtime.InteropServices.StructLayoutAttribute(System.Runtime.InteropServices.LayoutKind.Explicit)> _
    Public Structure Anonymous_3f4bb2d9_b5e3_482f_a1cd_89cd5b104462

        '''Anonymous_3e34b4d1_5346_4e41_8d1c_a00e4f45de60
        <System.Runtime.InteropServices.FieldOffsetAttribute(0)> _
        Public Struct1 As Anonymous_3e34b4d1_5346_4e41_8d1c_a00e4f45de60
    ...
    <System.Runtime.InteropServices.StructLayoutAttribute(System.Runtime.InteropServices.LayoutKind.Explicit)> _
    Public Structure Anonymous_a0b7eb55_1311_474a_8d40_19409efee489

        '''Anonymous_a33fa63b_8218_4e8c_9c2c_042a1f4b4a06
        <System.Runtime.InteropServices.FieldOffsetAttribute(0)> _
        Public Struct1 As Anonymous_a33fa63b_8218_4e8c_9c2c_042a1f4b4a06

        '''ULONGLONG->unsigned __int64
        <System.Runtime.InteropServices.FieldOffsetAttribute(0)> _
        Public Lo64 As ULong
    End Structure

    <System.Runtime.InteropServices.StructLayoutAttribute(System.Runtime.InteropServices.LayoutKind.Sequential)> _
    Public Structure Anonymous_7b8f9219_bb63_4657_9da5_d001a008954a
    ...
    <System.Runtime.InteropServices.StructLayoutAttribute(System.Runtime.InteropServices.LayoutKind.Sequential)> _
    Public Structure Anonymous_3e34b4d1_5346_4e41_8d1c_a00e4f45de60
    ...
    <System.Runtime.InteropServices.StructLayoutAttribute(System.Runtime.InteropServices.LayoutKind.Sequential)> _
    Public Structure Anonymous_a33fa63b_8218_4e8c_9c2c_042a1f4b4a06
    ...
    Partial Public Class NativeMethods
        ...
        Public Overloads Shared Function ReverseString(<System.Runtime.InteropServices.InAttribute(), System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.LPWStr)> ByVal orig As String, <System.Runtime.InteropServices.OutAttribute(), System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.LPWStr)> ByVal buffer As System.Text.StringBuilder, ByVal size As Integer) As <System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.Bool)> Boolean
        End Function
        ...
        Public Overloads Shared Function GetVeryLongString(<System.Runtime.InteropServices.OutAttribute(), System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.LPWStr)> ByVal buffer As System.Text.StringBuilder, ByVal size As Integer) As Integer
        End Function
        ...
        Public Overloads Shared Function GetVeryLongString2(<System.Runtime.InteropServices.OutAttribute(), System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.LPWStr)> ByVal buffer As System.Text.StringBuilder, ByVal size As UInteger) As UInteger
        End Function

        '''Return Type: boolean
        '''s1: stringInStruct
        '''comp: wchar_t*
        <System.Runtime.InteropServices.DllImportAttribute("PInvokeTestLib.dll", EntryPoint:="VerifyStringInStructM1")> _
        Public Shared Function VerifyStringInStructM1(ByVal s1 As stringInStruct, <System.Runtime.InteropServices.InAttribute(), System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.LPWStr)> ByVal comp As String) As <System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.I1)> Boolean
        End Function
        ...
        '''m1: char*
        '''m2: wchar_t*
        <System.Runtime.InteropServices.DllImportAttribute("PInvokeTestLib.dll", EntryPoint:="PopulateStructWithDiffStringTypes")> _
        Public Shared Sub PopulateStructWithDiffStringTypes(ByRef s1 As structWithDiffStringTypes, <System.Runtime.InteropServices.InAttribute(), System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.LPStr)> ByVal m1 As String, <System.Runtime.InteropServices.InAttribute(), System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.LPWStr)> ByVal m2 As String)
        End Sub
        ...
        Public Overloads Shared Function CopyBstrToNoramlStr(<System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.BStr)> ByVal src As String, <System.Runtime.InteropServices.OutAttribute(), System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.LPWStr)> ByVal dest As System.Text.StringBuilder, ByRef size As UInteger) As <System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.I1)> Boolean
        End Function
        ...
        '''x: int
        '''y: int
        <System.Runtime.InteropServices.DllImportAttribute("PInvokeTestLib.dll", EntryPoint:="MultiplyWithCDecl", CallingConvention:=System.Runtime.InteropServices.CallingConvention.Cdecl)> _
        Public Shared Function MultiplyWithCDecl(ByVal x As Integer, ByVal y As Integer) As Integer
        End Function

        '''Return Type: int
        '''c1: simpleClass
        <System.Runtime.InteropServices.DllImportAttribute("PInvokeTestLib.dll", EntryPoint:="GetSimpleClassM1")> _
        Public Shared Function GetSimpleClassM1(ByVal c1 As simpleClass) As Integer
        End Function

        '''Return Type: int
        '''c1: simpleClass
        <System.Runtime.InteropServices.DllImportAttribute("PInvokeTestLib.dll", EntryPoint:="GetSimpleClassM2")> _
        Public Shared Function GetSimpleClassM2(ByVal c1 As simpleClass) As Integer
        End Function
