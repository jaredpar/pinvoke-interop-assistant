    ...
    public partial class NativeStorage
    {
        ...
        public IEnumerable<NativeName> NativeNames
        {
            get
            {
                ...
                foreach (TypedefTypeRow row in TypedefType.Rows)
                {
                    list.Add(Tuple.Create(row.Name, NativeSymbolKind.TypeDefType));
                }
        ...
        private bool TryLoadDefinedType(TypeReference typeRef, out NativeType nt)
        {
            ...
            switch (drow.Kind)
            {
                ...
                case NativeSymbolKind.EnumType:
                    ...
                    {
                        et.Values.Add(new NativeEnumValue(et.Name, row.Name, row.Value));
                    }
